...
class 	QuickParkAssistApplicationTests {
	...
	@Test
	void homeControllerBeanIsLoaded() {
		// Verifies that the HomeController bean is present in the application context
		boolean isBeanPresent = applicationContext.containsBean("homeController");
